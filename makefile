...
Modeller: boundingBox.o point.o node.o nodeGroup.o nodeModel.o nodeTransform.o sceneGraph.o Modeller.o 
	$(CC) -o $@ Modeller.o boundingBox.o point.o $(CFLAGS) $(LDFLAGS)
